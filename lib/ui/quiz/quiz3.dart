...
import 'package:cipherapp/ui/quiz/quiz4.dart';
...
class _Quiz3State extends State<Quiz3>
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Container(
                                  width: 400,
                                  child: Text(
                                    'متن آشکار THEY ARE GOING TO AFRICA را با رمزنگاری پلیفیر و با کلید NINJA بصورت رمز شده درآورید.',
  ...
  showResult() async {
    ...
    if (textController.text == 'UGGWISFHLBBDYTFMWENB') {
