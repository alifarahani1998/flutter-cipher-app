...
class PlayFair extends StatefulWidget {
  @override
  _PlayFair createState() => _PlayFair();
}

class _PlayFair extends State<PlayFair> {
  ...
  Future<void> responseFromNativeCode() async {
    try {
      final String result = await platform.invokeMethod('playfair', {'temp1' : [keyController.text, messageController.text.replaceAll(' ', '')]});
      setState(() {
        response = result;
      });
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                  ...
                  child: InkWell(
                    onTap: () => launch('https://en.wikipedia.org/wiki/Playfair_cipher'),
                    child: Row(
                      children: <Widget>[
                        Align(
