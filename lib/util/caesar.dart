...
class _CaesarState extends State<Caesar> {
  ...
  Future<void> responseFromNativeCode() async {
    try {
      final String result = await platform.invokeMethod('caesar', {
        "temp": [keyController.text, messageController.text.replaceAll(' ', '')]
      });
      setState(() {
        response = result;
      });
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                ...
                child: InkWell(
                  onTap: () => launch('https://en.wikipedia.org/wiki/Caesar_cipher'),
                  child: Row(
                    children: <Widget>[
                      Align(
