...
class _AffineState extends State<Affine> {
  ...
  Future<void> responseFromNativeCode() async {
    try {
      final String result = await platform.invokeMethod('affine', {'temp3' : [messageController.text.replaceAll(' ', ''), aController.text, bController.text]});
      setState(() {
        response = result;
      });
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                  ...
                  child: InkWell(
                    onTap: () => launch('https://en.wikipedia.org/wiki/Affine_cipher'),
                    child: Row(
                      children: <Widget>[
                        Align(
  ...
  void onPressedIconWithText() {
    ...
    if (aController.text.isNotEmpty && bController.text.isNotEmpty && messageController.text.isNotEmpty)
      complete = true;
    else complete = false;
